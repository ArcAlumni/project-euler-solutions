...
public class P11_LargestProductInGrid implements Solution {
    ...
    static String[][] arr = new String[][] {
            ...
            { "88", "36", "68", "87", "57", "62", "20", "72", "03", "46", "33", "67", "46", "55", "12", "32", "63",
                    "93", "53", "69" },
            { "04", "42", "16", "73", "38", "25", "39", "11", "24", "94", "72", "18", "08", "46", "29", "32", "40",
                    "62", "76", "36" },
    ...
    public String solve() throws Exception {
        ...
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr[0].length; j++) {
                ...
                if (j + 3 < arr[0].length) {
                    for (int k = 0; k < 4; k++) {
                        prod *= Integer.parseInt(arr[i][j + k]);
                    }
                ...
                if (i + 3 < arr.length) {
                    prod = 1;
                    for (int k = 0; k < 4; k++) {
                        prod *= Integer.parseInt(arr[i + k][j]);
                    }
                    max = Math.max(max, prod);
                }

                if (i + 3 < arr.length && j + 3 < arr[0].length) {
                    prod = 1;
                    for (int k = 0; k < 4; k++) {
                        prod *= Integer.parseInt(arr[i + k][j + k]);
                    }
                    max = Math.max(max, prod);
                }

                if (i + 3 < arr.length && j - 3 >= 0) {
                    prod = 1;
                    for (int k = 0; k < 4; k++) {
                        prod *= Integer.parseInt(arr[i + k][j - k]);
                    }
